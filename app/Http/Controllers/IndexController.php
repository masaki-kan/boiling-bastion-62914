...
class IndexController extends Controller
{
    ...
    if( isset( $request->son_first_man_img ) ){
      ...
      //webにupするときはこっち
      $name->son_first_man_img = $data_url;
    ...
    if( isset( $request->son_first_woman_img ) ){
      ...
      //webにupするときはこっち
      $name->son_first_woman_img = $data_url;
    ...
    if( isset( $request->son_second_man_img ) ){
      ...
      //webにupするときはこっち
      $name->son_second_man_img = $data_url;
    ...
    if( isset( $request->son_second_woman_img ) ){
      ...
      //webにupするときはこっち
      $name->son_second_woman_img = $data_url;
    ...
    if( isset( $request->son_third_man_img ) ){
      ...
      //webにupするときはこっち
      $name->son_third_man_img = $data_url;
    ...
    if( isset( $request->son_third_woman_img ) ){
      ...
      //webにupするときはこっち
      $name->son_third_woman_img = $data_url;
    ...
    public function userup( Request $request ){
      ...
      if( isset( $request->img_name ) ){
        ...
        //webにupするときはこっち
        $userimages->img_name = $user_data_url;
