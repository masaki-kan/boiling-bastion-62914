...
<div class="family">
  <span>家族構成</span>
  <p>空白でも可</p>
<form action="{{ route('familyupdata') }}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}
  <input type="hidden" name="id" value="{{ $create->id }}" style="display:none;">
  <input type="hidden" name="user_id" value="{{ $create->user_id }}" style="display:none;">
...
<h4>祖父</h4>
<input type="text" name="grandfather" value="{{ $create->grandfather }}">
</div>
</div>
@if( $errors->has('grandfather_img') )
<p>{{ $errors->first('grandfather_img') }}</p>
@endif
...
<div class="list_content">
<h4>祖母</h4>
<input type="text" name="grandmother" value="{{ $create->grandmother }}">
</div>
</div>
...
<div class="list_content">
<h4>父</h4>
<input type="text" name="father" value="{{ $create->father }}">
</div>
</div>
...
<div class="list_content">
<h4>母</h4>
<input type="text" name="mother" value="{{ $create->mother }}">
</div>
</div>
...
<div class="list_content">
<h4>長男</h4>
<input type="text" name="son_first_man" value="{{ $create->son_first_man }}">
</div>
</div>
...
<div class="list_content">
<h4>長女</h4>
<input type="text" name="son_first_woman" value="{{ $create->son_first_woman }}">
</div>
</div>
...
<div class="list_content">
<h4>次男</h4>
<input type="text" name="son_second_man" value="{{ $create->son_second_man }}">
</div>
</div>
...
<div class="list_content">
<h4>次女</h4>
<input type="text" name="son_second_woman" value="{{ $create->son_second_woman }}">
</div>
</div>
...
<div class="list_content">
<h4>三男</h4>
<input type="text" name="son_third_man" value="{{ $create->son_third_man }}">
</div>
</div>
...
<div class="list_content">
<h4>三女</h4>
<input type="text" name="son_third_woman" value="{{ $create->son_third_woman }}">
</div>
</div>
...
<label class="btn btn-primary button" for="submit">編集</label>
