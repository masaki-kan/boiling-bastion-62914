...
<div class="flex">
  ...
  <form method="POST" action="{{ route('login') }}" class="login_form">
      ...
      <div class="form-group row">
           <label for="email" class="col-md-4 col-form-label text-md-right"><i class="fas fa-user" style="margin-right: 15px;"></i>{{ __('E-Mail Address') }}</label>
